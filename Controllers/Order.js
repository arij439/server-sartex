...
exports.confirmOrder = async (req, res) => {
  ...
  `;
    ...
    const transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: 'arij.sma@polytechnicien.tn',
        pass: 'xilw cegt mdrr ooax'
      }
    });

    const mailOptions = {
      from: 'arij.sma@polytechnicien.tn',
      to: order.email,
...
exports.rejectOrder = async (req,res) => {
  ...
  try {
    ...
    // const emailBody = "Your order has been approved.";
    // await sendEmail(order.email, "Order Confirmation", emailBody);
